                ...
                XTask.postToMain(new Runnable() {
                    ...
                    public void run() {
                        ...
                        new MessageDialog(context)
                                .setContent(new FontBean(String.format(context.getString(R.string.tip_uri_authorization_permission_content), currentPath)))
                                .setConfirm(new FontBean(context.getString(R.string.option_confirm), 15), new BaseDialog.IOnConfirmListener() {
                                    @Override
                                ...
                                .setCancel(new FontBean(context.getString(R.string.option_cancel), 15), new BaseDialog.IOnCancelListener() {
                                    @Override
                                    public boolean onClick(View v, BaseDialog dialog) {
                                        dialog.dismiss();
                                        return false;
